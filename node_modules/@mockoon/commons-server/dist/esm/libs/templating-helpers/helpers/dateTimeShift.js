...
const dateTimeShift = function (options) {
    ...
    const dateToShift = date === undefined
        ...
        : typeof date === 'string'
            ? new Date(date)
            : date;
    if (typeof options === 'object' && (options === null || options === void 0 ? void 0 : options.hash)) {
    ...
    return dateFnsFormat(dateToShift, typeof format === 'string' ? format : "yyyy-MM-dd'T'HH:mm:ss.SSSxxx", {
