...
import { dedupSlashes, Methods, ParsedJSONBodyMimeTypes, ParsedXMLBodyMimeTypes, stringIncludesArrayItems } from '@mockoon/commons';
 ...
 * @param obj
 */
export const IsEmpty = (obj) => (Array.isArray(obj) || (obj instanceof Object && obj !== null)) &&
 ...
 * @param route
 */
export function CreateInFlightRequest(requestId, request, route) {
 ...
 * @returns
 */
export const fromSafeString = (value) => value instanceof SafeString ? value.toString() : value;
/**
 ...
 */
export const isSafeJSONPath = (path) => {
    var _a;
 ...
 * @returns
 */
getValueFromPath.jmesPath = (data, path, defaultValue) => {
    if ((Array.isArray(data) || typeof data === 'object') &&
        typeof path === 'string' &&
        path !== '') {
        let foundValue;
 ...
 * @returns
 */
getValueFromPath.jsonPath = (data, path, defaultValue) => {
    if ((Array.isArray(data) || typeof data === 'object') &&
        typeof path === 'string' &&
        path !== '') {
        let foundValue;
 ...
 * @returns
 */
getValueFromPath.objectPath = (data, path, defaultValue) => {
    if ((Array.isArray(data) || typeof data === 'object') &&
        typeof path === 'string' &&
        path !== '') {
 ...
 * @param request
 */
export const parseWebSocketMessage = (messageData, request) => {
 ...
 * @param request
 */
export const parseRequestMessage = (data, request) => {
 ...
 * @returns boolean
 */
export const isValidStatusCode = (statusCode) => {
