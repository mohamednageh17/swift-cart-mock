 ...
 * @returns
 */
export const routesFromFolder = (folderChildren, allFolders, allRoutes, exclude = []) => {
    const routesList = [];
    folderChildren.forEach((folderChild) => {
        if (folderChild.type === 'route') {
            ...
            if (subFolder) {
                routesList.push(...routesFromFolder(subFolder.children, allFolders, allRoutes, exclude));
            }
        }
    });
    return routesList;
