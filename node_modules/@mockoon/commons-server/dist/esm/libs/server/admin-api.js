import { EnvironmentSchema } from '@mockoon/commons';
import { Sse } from './sse';
/**
 * Creates the Admin API endpoints
 * Documentation: https://mockoon.com/docs/latest/admin-api/overview/ *
 */
export const createAdminEndpoint = (app, serverInstance, { statePurgeCallback, getGlobalVariables, setGlobalVariables, purgeGlobalVariables, getDataBucket, getDataBuckets, purgeDataBuckets, getLogs, purgeLogs, envVarsPrefix, updateEnvironment }) => {
    ...
    app.put(`${adminApiPrefix}/environment`, (req, res) => {
        try {
            const environment = EnvironmentSchema.validate(req.body).value;
            if (!environment) {
