...
export const databucketActions = (crudId, databucket, request, response, routeCrudKey) => {
    ...
    const requestBody = request.body !== undefined ? request.body : request.stringBody || {};
    let responseBody = {};
    switch (crudId) {
        case 'get': {
        ...
        case 'create': {
            if (Array.isArray(databucket.value)) {
                ...
                if (typeof requestBody === 'object' &&
                    ...
                    setPath(requestBody, convertPathToArray(routeCrudKey), highestId !== null ? highestId + 1 : generateUUID());
                }
            ...
            if (Array.isArray(databucket.value)) {
                ...
                if (indexToModify !== -1) {
                    if (typeof databucket.value[indexToModify] === 'object' &&
                        ...
                        const currentItemId = getPath(databucket.value[indexToModify], convertPathToArray(routeCrudKey));
                        databucket.value[indexToModify] = Object.assign({}, (typeof requestBody === 'object' && requestBody != null
                            ? requestBody
                            : {}));
                        // restore the id if it was not provided in the request body
                        if (getPath(requestBody, convertPathToArray(routeCrudKey)) ===
                            undefined) {
                            setPath(databucket.value[indexToModify], convertPathToArray(routeCrudKey), currentItemId);
                        }
