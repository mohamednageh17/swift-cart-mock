...
const findItemIndex = (databucketValue, request, routeCrudKey) => databucketValue.findIndex((value, index) => {
    if (typeof value === 'object' && value !== null) {
        if ((0, object_path_1.get)(value, routeCrudKey) == null) {
            return false;
        }
        return (0, object_path_1.get)(value, routeCrudKey).toString() === request.params.id;
    }
    else {
        ...
        case 'create': {
            if (Array.isArray(databucket.value)) {
                ...
                if (typeof requestBody === 'object' &&
                    requestBody != null &&
                    (0, object_path_1.get)(requestBody, routeCrudKey) === undefined) {
                    ...
                    if (props.length === 1) {
                        ...
                        for (let propsIndex = 0; propsIndex < props.length; propsIndex++) {
                            if (propsIndex === props.length - 1) {
                                tempObject[props[propsIndex]] = (0, commons_1.generateUUID)();
                            }
                            else {
