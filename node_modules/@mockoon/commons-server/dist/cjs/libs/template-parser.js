 ...
 * @throws {Error}
 */
const TemplateParser = function ({ shouldOmitDataHelper, content, environment, processedDatabuckets, globalVariables, request, response, envVarsPrefix, publicBaseUrl }) {
    ...
    if (request) {
        helpers = Object.assign(Object.assign({}, helpers), (0, request_helpers_1.RequestHelpers)(request, environment, publicBaseUrl));
    }
    if (response) {
