...
class ResponseRulesInterpreter {
    constructor(routeResponses, request, responseMode, environment, processedDatabuckets, globalVariables, envVarsPrefix, publicBaseUrl) {
        ...
        this.isValidRule = (rule, requestNumber, requestMessage) => {
            ...
            if (rule.target === 'request_number') {
                ...
                if (parsedRuleModifier) {
                    ...
                    if (requestMessage) {
                        target =
                            rule.target === 'body'
                                ? (0, utils_1.parseRequestMessage)(requestMessage || '', this.request)
                                : target;
                    }
                    targetValue = (0, utils_1.getValueFromPath)(target, parsedRuleModifier, undefined);
                }
                else {
                    /**
            ...
            if (rule.operator === 'valid_json_schema') {
                const schema = (0, object_path_1.get)(this.targets.data_bucket, (0, utils_1.convertPathToArray)(rule.value));
                if (!schema) {
                    return false;
                }
                try {
    ...
    extractTargets() {
        ...
        if (requestContentType &&
            (0, commons_1.stringIncludesArrayItems)(commons_1.ParsedBodyMimeTypes, requestContentType) &&
        ...
        try {
            parsedValue = (0, template_parser_1.TemplateParser)({
                ...
                request: requestMessage
                    ? (0, requests_1.fromServerRequest)(this.request, requestMessage)
                    : this.request,
