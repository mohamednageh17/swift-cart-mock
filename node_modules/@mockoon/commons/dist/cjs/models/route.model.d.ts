...
export type ResponseRuleOperators = 'equals' | 'regex' | 'regex_i' | 'null' | 'empty_array' | 'array_includes' | 'valid_json_schema';
...
export type ResponseRuleTargets = 'body' | 'query' | 'header' | 'cookie' | 'params' | 'path' | 'method' | 'request_number' | 'global_var' | 'data_bucket' | 'templating';
