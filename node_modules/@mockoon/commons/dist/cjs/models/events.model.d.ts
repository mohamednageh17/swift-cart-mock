...
import { InFlightRequest, InvokedCallback, ProcessedDatabucketWithoutValue, Transaction } from './server.model';
export type ServerEvents = {
    error: (errorCode: ServerErrorCodes, originalError: Error | null, 
    /**
    ...
    'ws-closed': (request: InFlightRequest, wsCode: number, reason?: string | null) => void;
     ...
     * @returns
     */
    'data-bucket-processed': (dataBuckets: ProcessedDatabucketWithoutValue[]) => void;
};
