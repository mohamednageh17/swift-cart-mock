 ...
 */
const BuildWebSocketRoute = (hasDefaultRouteResponse = true, options = {
    endpoint: environment_schema_constants_1.RouteDefault.endpoint,
    body: environment_schema_constants_1.RouteResponseDefault.body
}) => {
    const defaultResponse = Object.assign(Object.assign({}, (0, exports.BuildRouteResponse)()), { default: true, body: options.body, sendFileAsBody: true });
    return Object.assign(Object.assign({}, environment_schema_constants_1.RouteDefault), { streamingInterval: 100, type: route_model_1.RouteType.WS, method: route_model_1.Methods.get, endpoint: options.endpoint, responses: hasDefaultRouteResponse ? [defaultResponse] : [] });
};
exports.BuildWebSocketRoute = BuildWebSocketRoute;
/**
...
const BuildEnvironment = (params = {
    ...
    if (params.hasContentTypeHeader) {
        headers.push((0, exports.BuildHeader)('Content-Type', 'application/json'));
    }
    if (params.hasCorsHeaders) {
        headers.push(...common_constants_1.CORSHeaders);
    }
    return Object.assign(Object.assign({}, environment_schema_constants_1.EnvironmentDefault), { port: (_a = params.port) !== null && _a !== void 0 ? _a : environment_schema_constants_1.EnvironmentDefault.port, routes: params.hasDefaultRoute ? [newRoute] : [], headers, proxyReqHeaders: [(0, exports.BuildHeader)()], proxyResHeaders: [(0, exports.BuildHeader)()], rootChildren: params.hasDefaultRoute
