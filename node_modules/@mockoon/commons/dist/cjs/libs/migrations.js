...
exports.Migrations = [
    ...
    // 1.3.0
    {
        ...
        migrationFunction: (environment) => {
            ...
            environment.routes.forEach((route) => {
                ...
                (_a = route.documentation) !== null && _a !== void 0 ? _a : (route.documentation = '');
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                ...
                route.responses.push({
                    uuid: (0, utils_1.generateUUID)(),
                    statusCode: (_a = route.statusCode) !== null && _a !== void 0 ? _a : '200',
                    label: '',
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    var _a;
                    (_a = routeResponse.disableTemplating) !== null && _a !== void 0 ? _a : (routeResponse.disableTemplating = false);
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    var _a;
                    (_a = routeResponse.rulesOperator) !== null && _a !== void 0 ? _a : (routeResponse.rulesOperator = 'OR');
                });
            });
        }
    },
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                var _a;
                var _b;
                (_a = (_b = route).randomResponse) !== null && _a !== void 0 ? _a : (_b.randomResponse = false);
            });
        }
    },
    /**
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                var _a;
                var _b;
                (_a = (_b = route).sequentialResponse) !== null && _a !== void 0 ? _a : (_b.sequentialResponse = false);
            });
        }
    },
    /**
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            var _a;
            (_a = environment.proxyRemovePrefix) !== null && _a !== void 0 ? _a : (environment.proxyRemovePrefix = false);
        }
    },
    /**
     * Add hostname
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    var _a;
                    (_a = routeResponse.fallbackTo404) !== null && _a !== void 0 ? _a : (routeResponse.fallbackTo404 = false);
                });
            });
        }
    },
            ...
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    routeResponse.rules.forEach((rule) => {
                        ...
                        (_a = rule.operator) !== null && _a !== void 0 ? _a : (rule.operator = environment_schema_constants_1.ResponseRuleDefault.operator);
                        delete rule.isRegex;
                    });
                });
            });
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                var _a;
                (_a = route.responseMode) !== null && _a !== void 0 ? _a : (route.responseMode = route
                    .sequentialResponse
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    routeResponse.rules.forEach((rule) => {
                        var _a;
                        (_a = rule.invert) !== null && _a !== void 0 ? _a : (rule.invert = environment_schema_constants_1.ResponseRuleDefault.invert);
                    });
                });
            });
        }
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            var _a;
            (_a = environment.data) !== null && _a !== void 0 ? _a : (environment.data = environment_schema_constants_1.EnvironmentDefault.data);
        }
    },
    /**
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    var _a;
                    (_a = routeResponse.databucketID) !== null && _a !== void 0 ? _a : (routeResponse.databucketID = environment_schema_constants_1.RouteResponseDefault.databucketID);
                    //
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            var _a, _b;
            (_a = environment.folders) !== null && _a !== void 0 ? _a : (environment.folders = environment_schema_constants_1.EnvironmentDefault.folders);
            (_b = environment.rootChildren) !== null && _b !== void 0 ? _b : (environment.rootChildren = environment.routes.map((route) => ({
                type: 'route',
                uuid: route.uuid
            })));
        }
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                var _a;
                (_a = route.type) !== null && _a !== void 0 ? _a : (route.type = environment_schema_constants_1.RouteDefault.type);
            });
        }
    },
    /**
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    var _a;
                    (_a = routeResponse.crudKey) !== null && _a !== void 0 ? _a : (routeResponse.crudKey = environment_schema_constants_1.RouteResponseDefault.crudKey);
                });
            });
        }
    },
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            if (environment.routes) {
                environment.routes.forEach((route) => {
                    route.streamingMode = environment_schema_constants_1.RouteDefault.streamingMode;
                    route.streamingInterval = environment_schema_constants_1.RouteDefault.streamingInterval;
                });
            }
        }
    }
