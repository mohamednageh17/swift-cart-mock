...
import { BodyTypes, Methods, RouteType } from '../models/route.model';
import { crudRoutesBuilder, GetRouteResponseContentType, isContentTypeApplicationJson, RemoveLeadingSlash, routesFromFolder } from '../utils/utils';
import { BuildEnvironment, BuildHeader, BuildHTTPRoute, BuildRouteResponse } from './schema-builder';
/**
                ...
                if (routeMethod in Methods) {
                    ...
                    Object.keys(parsedRoute.responses).forEach((responseStatus) => {
                        ...
                        if ((statusCode >= 100 && statusCode <= 999) ||
                            ...
                            // extract schema
                            const contentTypeHeader = contentTypeHeaders.find((header) => isContentTypeApplicationJson(header));
                    ...
                    const newRoute = Object.assign(Object.assign({}, BuildHTTPRoute(false)), { documentation: parsedRoute.summary || parsedRoute.description || '', method: routeMethod, endpoint: RemoveLeadingSlash(this.routeParametersReplace(routePath)), responses: routeResponses });
