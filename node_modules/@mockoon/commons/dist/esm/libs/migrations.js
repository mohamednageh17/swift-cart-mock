import { EnvironmentDefault, ResponseRuleDefault, RouteDefault, RouteResponseDefault } from '../constants/environment-schema.constants';
import { PostMigrationActionCollapsedFolders, PostMigrationActionDisabledRoutes } from '../models/migrations.model';
import { BodyTypes, ResponseMode } from '../models/route.model';
...
export const Migrations = [
            ...
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    routeResponse.rules.forEach((rule) => {
                        ...
                        (_a = rule.operator) !== null && _a !== void 0 ? _a : (rule.operator = ResponseRuleDefault.operator);
                        delete rule.isRegex;
                    });
                });
            });
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    routeResponse.rules.forEach((rule) => {
                        var _a;
                        (_a = rule.invert) !== null && _a !== void 0 ? _a : (rule.invert = ResponseRuleDefault.invert);
                    });
                });
            });
        }
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            var _a;
            (_a = environment.data) !== null && _a !== void 0 ? _a : (environment.data = EnvironmentDefault.data);
        }
    },
    /**
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    var _a;
                    (_a = routeResponse.databucketID) !== null && _a !== void 0 ? _a : (routeResponse.databucketID = RouteResponseDefault.databucketID);
                    //
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            var _a, _b;
            (_a = environment.folders) !== null && _a !== void 0 ? _a : (environment.folders = EnvironmentDefault.folders);
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                var _a;
                (_a = route.type) !== null && _a !== void 0 ? _a : (route.type = RouteDefault.type);
            });
        }
    },
    /**
     ...
     */
    {
        ...
        migrationFunction: (environment) => {
            environment.routes.forEach((route) => {
                route.responses.forEach((routeResponse) => {
                    var _a;
                    (_a = routeResponse.crudKey) !== null && _a !== void 0 ? _a : (routeResponse.crudKey = RouteResponseDefault.crudKey);
                });
            });
        }
    },
